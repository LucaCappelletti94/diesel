...
* Added `DatabaseErrorInformation::sqlstate` for retrieving the SQLSTATE error code that PostgreSQL, MySQL and MariaDB report with an error. It defaults to `None`, so SQLite is unaffected
